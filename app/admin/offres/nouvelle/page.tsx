...
export default function NouvelleOffrePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Normaliser le statut - TRÈS IMPORTANT !
      const normalizedStatus = formData.status === 'publiee' ? 'publiee' : formData.status;
      ...
      const offerData = {
        ...
        missions: formData.missions || null,
        ...
        published_at: normalizedStatus === 'publiee' ? new Date().toISOString() : null
      };

      console.log('📤 Création offre avec statut:', normalizedStatus);
      ...
      <div className="container mx-auto px-4 py-8">
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    required
                    className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-info-500 focus:border-transparent outline-none bg-white"
                  >
                  ...
                  {formData.title === 'custom' && (
                    <input
                      ...
                      className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-info-500 focus:border-transparent outline-none mt-2"
                      autoFocus
                    />
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-info-500 focus:border-transparent outline-none"
                ...
                {imagePreview ? (
                  <div className="relative w-full h-64 rounded-lg overflow-hidden">
                    ...
                    <button
                      type="button"
                      onClick={removeImage}
                      className="absolute top-2 right-2 bg-danger-500 text-white p-2 rounded-full hover:bg-danger-600 transition-colors"
                    >
                      <FaTimes className="w-4 h-4" />
                    </button>
                  </div>
                ) : (
                  <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-neutral-300 rounded-lg cursor-pointer hover:border-info-500 transition-colors">
                    <FaImage className="w-12 h-12 text-neutral-400 mb-3" />
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-info-500 focus:border-transparent outline-none resize-none"
            ...
            <div className="bg-gradient-to-br from-info-50 to-primary-50 border border-info-200 rounded-lg p-6">
              <h2 className="text-lg font-semibold text-info-900 mb-1 flex items-center gap-2">
                🎓 Profil recherché
              </h2>
              ...
              <div className="space-y-6">
                {/* Formation */}
                <div>
                  <label className="block text-sm font-semibold text-info-800 mb-2">
                    📚 Formation
                  </label>
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={3}
                    className="w-full px-4 py-3 border border-info-200 rounded-lg focus:ring-2 focus:ring-info-500 focus:border-transparent outline-none resize-none bg-white"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={8}
                    className="w-full px-4 py-3 border border-info-200 rounded-lg focus:ring-2 focus:ring-info-500 focus:border-transparent outline-none resize-none bg-white font-mono text-sm"
            ...
            <div className="flex items-center justify-end gap-4 pt-6 border-t border-neutral-200">
              ...
              <button
                type="submit"
                disabled={loading}
                className="inline-flex items-center gap-2 bg-info-600 text-white px-6 py-3 rounded-lg hover:bg-info-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
